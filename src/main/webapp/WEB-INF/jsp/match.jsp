		...
		<div class="col-sm-9 col-xs-9">
			...
			<div class="panel panel-default panel-match">
				<div class="panel-body">
					...
					<div class="col-sm-7">${user.edad}</div>
				</div>
			</div>
			<div class="panel panel-default panel-match">
				<div class="panel-body">
					<div class="col-sm-5">Ciudad</div>
					<div class="col-sm-7">${user.ciudad}</div>
				</div>
			</div>
		</div>
	</div>
...
<!-- 		<hr />
		...
		<button type="button" class="btn btn-block btn-info btn-lg"
			...
			style="background-color: #13c1ac; color:">Enviar mensaje</button>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header"
						style="background-color: #13c1ac; color: white;">
 ...
 -->
		...
		<a href="/chat?id=${match.id}" class="btn btn-block btn-lg btn-info">Enviar
			mensaje</a>
