...
INSERT INTO quest(id, titulo, descripcion, url) VALUES (3, 'Aventura en el bosque', 'Ponte en situación. Imagina que un grupo de asesinos os secuestran a ti y a una persona más y escapais encontrandoos en un bosque, ¿cómo harías para salir de allí?', 'url_del_json');
