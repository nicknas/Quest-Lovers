	...
	var id = getParam("id");
	 ...
	 .done(function (response, textStatus, jqXHR){
		 if (console && console.log){
			 console.log( "La solicitud de url se ha completado correctamente." );
	         ...
	         jQuery.ajax({
	     	 ...
	     	 .fail(function( jqXHR, textStatus, errorThrown ) {
	     	     if ( console && console.log ) {
	     	         console.log( "La solicitud del quest ha fallado: " +  textStatus);
	     	     }
	     	});
		 }
	 })
	 .fail(function( jqXHR, textStatus, errorThrown ) {
	     if ( console && console.log ) {
	         console.log( "La solicitud de url ha fallado: " +  textStatus);
	     }
	});
