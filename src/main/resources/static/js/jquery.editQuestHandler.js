...
var nombre_finales = new Map();
	...
	jQuery(document).on("click", "#buttonSubmit", function(){
		...
		if (!linkToFinal){
			jQuery("form").before('<div class="alert alert-danger alert-dismissible"><input type="hidden" autofocus/><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>La quest debe tener enlace a algún final</strong></div>');
		}
		else {
