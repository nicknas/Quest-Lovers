...
INSERT INTO quest(id, titulo, descripcion, url) VALUES (1, 'Titulo Quest1', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation', '/tmp/iw/quest/esqueleto1.json');
INSERT INTO quest(id, titulo, descripcion, url) VALUES (2, 'Titulo Quest2', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation', '/tmp/iw/quest/esqueleto2.json');
INSERT INTO quest(id, titulo, descripcion, url) VALUES (3, 'Aventura en el bosque', 'Ponte en situación. Imagina que un grupo de asesinos os secuestran a ti y a una persona más y escapais encontrandoos en un bosque, ¿cómo harías para salir de allí?', '/tmp/iw/quest/esqueleto3.json');
INSERT INTO quest(id, titulo, descripcion, url) VALUES (4, 'Titulo Quest4', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation', '/tmp/iw/quest/esqueleto4.json');
